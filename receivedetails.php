  ...
  if ($_POST[sub_cat]!='-1')
   ...
   $con=$con." and tbl_receive.product=$_POST[sub_cat]";
     ...
     $user_query="select tbl_receive.id, tbl_order.dtDate as date,tbl_order.remarks,tbl_order.status,tbl_receive.donumber,tbl_product.punit as unit,
                   ...
                   tbl_company.name as company,tbl_product.name as product,tbl_receive.dfcost,tbl_receive.locost
                   from tbl_receive
...
<tr><td colspan="5" align="center"  id="trsubhead"><b>Goods Purchase Details Report</b></td></tr>
 <tr id="trhead"><td colspna="1"> Date</td><td>Company</td><td>Category</td><td>Product</td><td>&nbsp;</td></tr>
 <tr>
...
<table width="960px" align="center" bordercolor="#AACCBB" bgcolor="#FFFFFF"  border="1" cellspacing="5" cellpadding="5" style="border-collapse:collapse;">
 ...
 <tr id="trsubhead"><td colspan="1" align="left"><!--<b>Print</b>--></td>
                      <td colspan="4" align="left">Total Amount :</td>
                      <td align="right"><?=number_format($totalqty,2);?></td>
                      <td align="center"><?=$totalbundle;?></b></td>
                      <td align="right"><?=number_format($totalamount/$totalqty,2);?></td>                                        
                      <td align="right" colspan="3"><?=number_format($totalamount,2);?></td>
                      <td>&nbsp;</td>
  </tr>
 </table>
