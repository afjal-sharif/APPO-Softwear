...
if(isset($_POST["submit"]))
 {
  if ((empty($_POST[remarks]) and empty($_POST[remarksnew])) or !Is_Numeric($_POST[deposite]) or !Is_Numeric($_POST[withdraw])) 
   ...
   if($bank=='cash')
   {
     $remarks="Loan Receive :".$msgremarks ." ". $_POST[remarks1]; 
     ...
     echo "<b><img src='images/active.png' height='15px' width='15px'> Success !! Cash Loan Receive from $msgremarks Successfully.</b>";    
   }
   else
   {
     $remarks="Loan Receive :".$msgremarks . " ". $_POST[remarks1];
     ...
     db_query($sql) or die(mysql_error());
     echo "<img src='images/active.png' height='15px' width='15px'><b> Success !! Bank Loan Receive from $msgremarks Successfully.</b>";
   }
...
<table width="960px" align="center" bordercolor="#AABBCC" bgcolor="#FFFFFF"  border=2 celspacing=1 cellpadding=5 style="border-collapse:collapse;">
 ...
 <tr id="trhead"><td colspan="4">Lending & Borrowing : Receive Form</td></tr>  
 
 <tr id="trsubhead"><td> Date</td><td>Deposite To</td><td> Person </td><td>Amount Receive</td></tr>
    <tr bgcolor="#CCAABB">  
       ...
       <td align="center">
         <?
           ...
           $totalRows_sql = mysql_num_rows($sql);
         ?>
           <select name="remarks"  style="width: 250px;">
           <option value=""></option>
         <?
             do {  
         ?> 
       ...
       <td align="center"> <input type="text"  name="deposite"  size="10"  value="0"  />
        <input type="hidden"  name="withdraw"  size="6"  value="0"  /> </td>
     </tr>    
    <tr bgcolor="#CCAABB">  
