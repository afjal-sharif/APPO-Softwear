...
<table width="760px" align="center" bordercolor="#AACCBB" bgcolor="#FFFFFF"  border="1" cellspacing="5" cellpadding="5" style="border-collapse:collapse;">
...
<tr><td colspan="4" align="left">Print Date & Time: <? echo date("d-M-Y h:i A");?></td></tr>
 ...
 <tr id="trhead"><td colspan="4"><?=$global['site_name']?> Balance Sheet</td></tr>
