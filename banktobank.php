...
if(isset($_POST["submit"]))
 {
  if (!Is_Numeric($_POST[withdraw])) 
   ...
   $fbank=$_POST[fbank];
   $tbank=$_POST[tbank];
   $remarks="Bank To Bank Transfer To: $tbank ,Remarks :".$_POST[remarks];
   $sql="insert into tbl_bank (date,remarks,deposite,withdraw,balance,user,bank,type) 
        value('$_POST[demo12]','$remarks',0,$withdraw,$balance,'$_SESSION[userName]','$fbank',8)"; 
   db_query($sql) or die(mysql_error());
   
   $remarks="Bank To Bank Receive From: $fbank ,Remarks :".$_POST[remarks];
   $sql="insert into tbl_bank (date,remarks,deposite,withdraw,balance,user,bank,type) 
        value('$_POST[demo12]','$remarks',$withdraw,0,(-1)*$balance,'$_SESSION[userName]','$tbank',8)"; 
   db_query($sql) or die(mysql_error());

  
   echo "<img src='images/active.png' height='15px' width='15px'><b> Success !! Bank to Bank Transfer Successfully.</b>";
   } // Error chech If
 }// Submit If
?>
...
<?
  ...
  <tr id="trhead"><td>Bank Name</td><td>Branch Name</td><td>Account Code</td><td>Current Balance</td><td>CC Limit</td><td> Balance</td></tr>
  <?  
  $bankbal=0;  
...
<table width="960px" align="center" bordercolor="#AACCBB" bgcolor="#FFFFFF"  border="1" cellspacing="5" cellpadding="5" style="border-collapse:collapse;">
 ...
 <tr>
     ...
     <td colspan="1" bgcolor="#FF0c9">Bank: </td>
     <td colspan="2" bgcolor="#FF0c9"><b><?=number_format($bankbal,2);?></b></td>
...
<table width="960px" align="center" bordercolor="#AABBCC" bgcolor="#FFFFFF"  border=2 celspacing=1 cellpadding=5 style="border-collapse:collapse;">
 ...
 -->
 <tr id="trhead"><td colspan="5">Bank To Bank Transection</td></tr>  
 
 <tr id="trsubhead"><td> Date</td><td>From Bank Code.</td><td> Remarks </td><td>To Bank Code.</td><td>Amount</td> </tr>
    <tr bgcolor="#FFCCAA">  
        <td colspan="1" align="left"> 
         ...
         ?>
           <select name="fbank"  style="width: 220px;">
         <?
             do {  
         ?>
            <option value="<?php echo $row_sql['accountcode'];?>" <?php if($_POST["fbank"]==$row_sql['accountcode']) echo "selected";?> ><?php echo $row_sql['bankname']?> : <?php echo $row_sql['accountcode']?>  </option>
         <?
       ...
       <td align="center"><input type="text" name="remarks" value="" size="30" /></td>
         ...
         <?
           ...
           $totalRows_sql = mysql_num_rows($sql);
         ?>
           <select name="tbank"  style="width: 220px;">
         <?
             do {  
         ?>
            <option value="<?php echo $row_sql['accountcode'];?>" <?php if($_POST["tbank"]==$row_sql['accountcode']) echo "selected";?> ><?php echo $row_sql['bankname']?> : <?php echo $row_sql['accountcode']?>  </option>
         <?
               } while ($row_sql = mysql_fetch_assoc($sql));
         ?>
          </select>
...
<table width="960px" align="center" bordercolor="#AACCBB" bgcolor="#FFFFFF"  border="1" cellspacing="5" cellpadding="5" style="border-collapse:collapse;">
 <tr id="trhead"><td colspan="8">Display Last 10 B2B Transection</td></tr> 
   ...
   <tr bgcolor="#FFCCAA">    
    ...
    <?
      $user_query="Select * from tbl_bank where type=0 or type=8 order by id desc limit 0,10";
      $users = mysql_query($user_query);
      ...
      if ($total>0)
      {
       ...
       <tr>
          ...
          <td><?=$value[user];?></td>  
          <td align="center"><!--<b><a href="clearbank.php?id=<?=$value[id];?>&mode=b2b" title="Delete">X</a></b>--></td>      
       </tr>
       <?
       }
      }
