...
<table width="960px" align="center" bordercolor="#AACCBB" bgcolor="#FFFFFF"  border="1" cellspacing="5" cellpadding="5" style="border-collapse:collapse;">
 ...
 <tr align="center">
       <td> 
         <input type="Text" id="demo11" maxlength="15" size="8" value="<?=isset($_POST["demo11"])?$_POST["demo11"]:date('Y-m-d')?>" name="demo11";>
           <a href="javascript: NewCssCal('demo11','yyyymmdd','dropdown')"> 
           <img src="images/cal.gif" width="16" height="15" alt="Pick a date"></a>
   
       To: 
       <input type="Text" id="demo12" maxlength="15" size="8" value="<?=isset($_POST["demo12"])?$_POST["demo12"]:date('Y-m-d')?>" name="demo12";>
    ...
    if(isset($_POST["view"]))
     {
      ...
      $sql="update tbl_incentive_pay set date=indate where date='0000-00-00'";
      db_query($sql);
      
      $con="where tbl_incentive_pay.type<>5 and (date between '$_POST[demo11]' and '$_POST[demo12]')";
      ...
      if ($_POST[year]!='')
       {
         $con=$con. " and left(tbl_incentive_pay.batch,4)='$_POST[year]'";
       }
       */ 
